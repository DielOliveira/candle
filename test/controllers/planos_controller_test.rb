...
class PlanosControllerTest < ActionController::TestCase
  ...
  test "should create plano" do
    assert_difference('Plano.count') do
      post :create, plano: { descricao: @plano.descricao, diasvalidos: @plano.diasvalidos, valor: @plano.valor }
    end
  ...
  test "should update plano" do
    patch :update, id: @plano, plano: { descricao: @plano.descricao, diasvalidos: @plano.diasvalidos, valor: @plano.valor }
    assert_redirected_to plano_path(assigns(:plano))
  end
