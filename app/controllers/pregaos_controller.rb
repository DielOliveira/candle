class PregaosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pregao.save
        format.html { redirect_to @pregao, notice: 'Pregao was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @pregao.update(pregao_params)
        format.html { redirect_to @pregao, notice: 'Pregao was successfully updated.' }
  ...
  def destroy
    @pregao.destroy
    respond_to do |format|
      format.html { redirect_to pregaos_url, notice: 'Pregao was successfully destroyed.' }
